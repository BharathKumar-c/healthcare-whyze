...
export default function Quit({
  ...
  const handleInputChange = (event) => {
    const study = JSON.parse(JSON.stringify(segments));
    study[activeSegment.index].feasibilityStudy[parentIndex].child[0].quit[
      event.target.name
    ] = event.target.value;
    dispatch(setSegments(study));
  };
  ...
  return (
    ...
    >
      <Space direction="vertical" className="container">
        <div className="quit-container-alignment">
          ...
          <div className="condition-container-input">
            <Input
              ...
              lable="Started year"
              name="startYear"
              value={caseDetails?.quit?.startYear}
          ...
          <div className="condition-container-input">
            <Input
              ...
              lable="Quit year"
              name="quitYear"
              value={caseDetails?.quit?.quitYear}
              handleInputChange={handleInputChange}
              onWheel={(e) => e.target.blur()}
            />
          </div>
