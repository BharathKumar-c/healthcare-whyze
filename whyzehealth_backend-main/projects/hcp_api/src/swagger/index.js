...
const masterDataSwagger = require('../controllers/masterData/masterDataSwagger');
...
module.exports = {
  ...
  servers: [
    {
      url: 'http://dev-w-devhc-ygpa5xcns75l-1309274599.eu-west-1.elb.amazonaws.com',
    },
  ],
